namespace Kahnban_ToDo
{
    partial class OrganizationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            DataGridView_Projects.BackgroundColor = SystemColors.ControlDarkDark;
            ...
            DataGridView_Projects.Location = new Point(6, 91);
            DataGridView_Projects.Margin = new Padding(6);
            DataGridView_Projects.Name = "DataGridView_Projects";
            DataGridView_Projects.ReadOnly = true;
            DataGridView_Projects.RowHeadersVisible = false;
            DataGridView_Projects.ShowCellToolTips = false;
            DataGridView_Projects.Size = new Size(972, 444);
